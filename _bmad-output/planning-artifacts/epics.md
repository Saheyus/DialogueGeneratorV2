...
- **Epic 0**: [Infrastructure & Setup (Brownfield Adjustments)](epics/epic-00.md)  
...
- **Epic 1**: [Génération de dialogues assistée par IA](epics/epic-01.md)  
...
- **Epic 2**: [Éditeur de graphe de dialogues](epics/epic-02.md)  
...
- **Epic 3**: [Gestion du contexte narratif (GDD)](epics/epic-03.md)  
...
- **Epic 4**: [Validation et assurance qualité](epics/epic-04.md)  
...
- **Epic 5**: [Export et intégration Unity](epics/epic-05.md)  
...
- **Epic 6**: [Templates et réutilisabilité](epics/epic-06.md)  
...
- **Epic 7**: [Collaboration et contrôle d'accès](epics/epic-07.md)  
...
- **Epic 8**: [Gestion des dialogues et recherche](epics/epic-08.md)  
...
- **Epic 9**: [Variables et intégration systèmes de jeu](epics/epic-09.md)  
...
- **Epic 10**: [Gestion de session et sauvegarde](epics/epic-10.md)  
...
- **Epic 11**: [Onboarding et guidance](epics/epic-11.md)  
...
- **Epic 12**: [Expérience utilisateur et workflow](epics/epic-12.md)  
...
- **Epic 13**: [Monitoring et analytics](epics/epic-13.md)  
...
- **Epic 14**: [Accessibilité](epics/epic-14.md)  

...
- **Stack :** Interface web React (`npm run dev`) — Interface principale du projet.
...
1. **UI tech** : Interface web React — Interface principale du projet.

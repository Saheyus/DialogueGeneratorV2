...
class Interaction(BaseModel):
    ...
    header_commands: List[str] = Field(default_factory=list, description="Commandes Yarn à exécuter au début de l'interaction (avant les éléments).")
    header_tags: List[str] = Field(default_factory=list, description="Tags de l'en-tête Yarn (ex: pour la couleur, le suivi)." )
